<h2><a href="https://www.geeksforgeeks.org/problems/rearrange-the-array-1639032648/1?_gl=1*1e4q9iy*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwmdLSBhANEiwAkREMN3W4yOHIC6KE0THpEntr8kQakJGypPY7H-j30vhCal5y0k-VlXPe8xoCDgIQAvD_BwE&gbraid=0AAAAAC9yBkCr1sWDm-MLcqvAy4DQmY0zP">Rearrange the Array</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Consider an array<strong> </strong></span><span style="font-size: 18px;"><strong>a[]</strong> = [1, 2, 3, ..., n] and a permutation <strong>b[]</strong> of size n containing all integers from 1 to n exactly once.</span></p>
<ul>
