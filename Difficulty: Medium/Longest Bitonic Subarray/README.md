<h2><a href="https://www.geeksforgeeks.org/problems/maximum-length-bitonic-subarray5730/1?_gl=1*lmyt2s*_up*MQ..*_gs*MQ..&gclid=Cj0KCQjw39zSBhDhARIsANammDvX7OZvrqZ3-idIrj1V9gf9YUvfl0Np-qfamkFi6c5UaOaUGc_CeCQaAiqVEALw_wcB&gbraid=0AAAAAC9yBkApXVukHCL9Tw7T_2nx9my0M">Longest Bitonic Subarray</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong>&nbsp;containing positive integers, return the maximum length of the bitonic<strong> </strong>subarray.</span></p>
